...
Our last assumption holds due to central limit theorem (figure 3) and the fact that our data looks approximately normal (figure 1). To confirm our results, we can do a qqplot
